...
contract alquiler {
  ...
  function obtenerTodasLasPropiedades() public view returns (Propiedad[] memory) {
    return propiedades;
  }
  ...
  function anhadirPropiedad(string memory _nombre, string memory _direccion, string memory _estado, uint _precioDia, string memory _imagenCID) public {
    Propiedad memory nuevaPropiedad = Propiedad(_nombre, _direccion, _estado, _precioDia, _imagenCID);
  ...
  function modificarPropiedad(uint _idPropiedad, string memory _nombre, string memory _direccion, string memory _estado, uint _precioDia, string memory _imagenCID) public onlyOwnerOf(_idPropiedad) {
    ...
    propiedadAModificar.imagenCID = _imagenCID;
  }
